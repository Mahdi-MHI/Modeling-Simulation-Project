...
%>>>>>>> 66eddc254fd2898dce3c3a49326ec02f2f833e27
        ...
        %T(1,k) = (u0*Rof(i,k)*Cpf(i,k)*T0 + keffz*Az(1,2:end-1)*T(:,k) + keffz*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)) )/((1 + keffz*Az(end,1)*Az(1,end)/Az(end,end))*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1)));
        %T(N+2,k)= (-Az(end,2:end-1)*T(2:end-1,k) - Az(end,1)*(u0*Rof(i,k)*Cpf(i,k)*T0 + keffz*Az(1,2:end-1)*T(:,k) + keffz*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)) )/((1 + keffz*Az(end,1)*Az(1,end)/Az(end,end))*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1))) )/Az(end,end);
        %T(i,1)= (-Ar(1,2:end-1)*T(i,:) - Ar(1,end)*(keffr*Ar(end,2:end-1)*T(i,:) + hw*Tb)/(hw - keffr*Ar(end,end)))/((1 + (keffr*Ar(1,end)*Ar(end,1))/((hw - keffr*Ar(end,end))*Ar(1,1) ) )*Ar(1,1));
        %T(i,M+2)= (keffr*Ar(end,2:end-1)*T(i,:) + hw*Tb + keffr*Ar(end,1)*(-Ar(1,2:end-1)*T(i,:) - Ar(1,end)*(keffr*Ar(end,2:end-1)*T(i,:) + hw*Tb)/(hw - keffr*Ar(end,end)))/((1 + (keffr*Ar(1,end)*Ar(end,1))/((hw - keffr*Ar(end,end))*Ar(1,1) ) )*Ar(1,1)) )/(hw - keffr*Ar(end,end));
        
        E_T(i,k)= -u0*Rof(i,k)*Cpf(i,k)*Az(i+1,2:end-1)*T(:,k) - u0*Rof(i,k)*Cpf(i,k)*Az(i+1,1)*'T(1,k)' -u0*Rof(i,k)*Cpf(i,k)*Az(i+1,end)*'T(N+2,k)'...
        ...
        E_T(i,k)= -u0*Rof(i,k)*Cpf(i,k)*Az(i+1,2:end-1)*T(:,k) - u0*Rof(i,k)*Cpf(i,k)*Az(i+1,1)*'T(1,k)' -u0*Rof(i,k)*Cpf(i,k)*Az(i+1,end)*'T(N+2,k)'...
            + keffz*Bz(i+1,2:end-1)*T(:,k) + keffz*Bz(i+1,1)*'T(1,k)' + keffz*Bz(i+1,end)*'T(N+2,k)' ...
            + keffr/R_nodes(k)*Ar(k+1,1)*T(i,:) + keffr/R_nodes(k)*Ar(k+1,1)*'T(i,1)' + keffr/R_nodes(k)*Ar(k+1,end)*'T(i,M+2)' ...
            + keffr*Br(k+1,2:end-1)*T(i,:) + keffr*Br(k+1,1)*'T(i,1)' + keffr*Br(k+1,end)*'T(i,M+2)' + (1-epsilon)*hg*as*(Ts(i,k) - T(i,k));
        
        E_T(i,k)= -u0*Rof(i,k)*Cpf(i,k)*Az(i+1,2:end-1)*T(:,k) - u0*Rof(i,k)*Cpf(i,k)*Az(i+1,1)*'(u0*Rof(i,k)*Cpf(i,k)*T0 + keffz*Az(1,2:end-1)*T(:,k) + keffz*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)) )/((1 + keffz*Az(end,1)*Az(1,end)/Az(end,end))*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1)))' -u0*Rof(i,k)*Cpf(i,k)*Az(i+1,end)*'(-Az(end,2:end-1)*T(2:end-1,k) - Az(end,1)*(u0*Rof(i,k)*Cpf(i,k)*T0 + keffz*Az(1,2:end-1)*T(:,k) + keffz*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)) )/((1 + keffz*Az(end,1)*Az(1,end)/Az(end,end))*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1))) )/Az(end,end)'...
            + keffz*Bz(i+1,2:end-1)*T(:,k) + keffz*Bz(i+1,1)*'(u0*Rof(i,k)*Cpf(i,k)*T0 + keffz*Az(1,2:end-1)*T(:,k) + keffz*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)) )/((1 + keffz*Az(end,1)*Az(1,end)/Az(end,end))*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1)))' + keffz*Bz(i+1,end)*'(-Az(end,2:end-1)*T(2:end-1,k) - Az(end,1)*(u0*Rof(i,k)*Cpf(i,k)*T0 + keffz*Az(1,2:end-1)*T(:,k) + keffz*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)) )/((1 + keffz*Az(end,1)*Az(1,end)/Az(end,end))*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1))) )/Az(end,end)' ...
            + keffr/R_nodes(k)*Ar(k+1,1)*T(i,:) + keffr/R_nodes(k)*Ar(k+1,1)*'(-Ar(1,2:end-1)*T(i,:) - Ar(1,end)*(keffr*Ar(end,2:end-1)*T(i,:) + hw*Tb)/(hw - keffr*Ar(end,end)))/((1 + (keffr*Ar(1,end)*Ar(end,1))/((hw - keffr*Ar(end,end))*Ar(1,1) ) )*Ar(1,1))' + keffr/R_nodes(k)*Ar(k+1,end)*'(keffr*Ar(end,2:end-1)*T(i,:) + hw*Tb + keffr*Ar(end,1)*(-Ar(1,2:end-1)*T(i,:) - Ar(1,end)*(keffr*Ar(end,2:end-1)*T(i,:) + hw*Tb)/(hw - keffr*Ar(end,end)))/((1 + (keffr*Ar(1,end)*Ar(end,1))/((hw - keffr*Ar(end,end))*Ar(1,1) ) )*Ar(1,1)) )/(hw - keffr*Ar(end,end))' ...
